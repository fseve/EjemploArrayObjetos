...
public class FormPersonas extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            Persona p = new Persona(); // CREAR PERSONA VACÍA
            p.setId(txtId.getText()); // LE MANDÓ EL ID QUE TIENE EL CUADRO DE TEXTO DEL ID
            p.setNombre(txtNombre.getText()); // IDEM
            p.setApellido(txtApellido.getText()); // IDEM
            
            lista.add(p); // AGREGARLO A LA LISTA
            
            JOptionPane.showMessageDialog(null, "REGISTRADO CORRECTAMENTE"); // MENSAJE DE CONFIRMACIÓN
            
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage()); // MENSAJE EN CASO DE ERROR
        }
